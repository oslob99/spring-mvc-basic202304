...
public class FileUtil {
    ...
    public static String uploadFile(
        ...
        // ex) 상어.png -> dosfhnoijcnosdfjaesof-sdfsd_상어.png
        String newFileName = UUID.randomUUID() + "_" + file.getOriginalFilename();

        // 이 파일을 저장할 날짜별 폴더를 생성
        // D:/spring-prj/upload/2023/05/16/sdfdsafsdf_상어.png
        ...
        // 저장된 파일의 풀경로
        String pullPath = newPath + "/" + newFileName;
